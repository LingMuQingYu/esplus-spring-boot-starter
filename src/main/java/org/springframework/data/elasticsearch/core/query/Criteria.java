...
public class Criteria {
	...
	private final List<CriteriaEntry> queryCriteriaEntries = new ArrayList<>();
	...
	public List<CriteriaEntry> getQueryCriteriaEntries() {
		return Collections.unmodifiableList(this.queryCriteriaEntries);
	}
	 ...
	 *
	 * @param boundingBox {@link GeoBox} bounding box(left top corner +
	 *          right bottom corner)
	 * @return this object
	 */
	 ...
	 * Adds a new filter CriteriaEntry for {@code location WITHIN distance}
	 *
	 * @param location {@link Point} center coordinates
	 * @param distance {@link Distance} radius .
	 * @return this object
	 */
	...
	public static class CriteriaEntry {
		...
		private Field field = new SimpleField("null");
